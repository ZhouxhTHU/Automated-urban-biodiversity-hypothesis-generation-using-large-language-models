...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--claude", type=Path, default=Path("LLMJudge_results/comparison_results_claude.xlsx"))
    parser.add_argument("--gemini", type=Path, default=Path("LLMJudge_results/comparison_results_gemini.xlsx"))
    parser.add_argument("--gpt", type=Path, default=Path("LLMJudge_results/comparison_results_gpt.xlsx"))
